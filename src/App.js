...
function App() {
  ...
  <div className='container'>
    <div className='container2'>
      ...
      <div>
         <TextField id="standard-basic" label="Ingresa tu ciudad" variant="standard" 
            onChange={(e) => {setCityName(e.target.value)}}/>
            {console.log(cityName)}
            <button type='button' onClick={() => getData()} className='button'> <BsSearch className='button2'/> </button>
              {weatherData !== null ? (
                  <div>  
                    <h4>Live Weather Condition</h4>
                      <h3>{weatherData.weather[0].main}</h3>
                       <div>
                         ...
                         <div>
                             <h3> <i>
                              </i>{weatherData.name} | {weatherData.sys.country}</h3>
                           </div>
                            <div>
